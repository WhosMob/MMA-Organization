...
- Implement Rankings page, News page, About page, Contact page (and `/news/[news-slug]` detail pages) as placeholders or full implementations so nav/footer links resolve. The Events link now resolves to the `/events` listing page.
