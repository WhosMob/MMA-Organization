...
export function ContactHero() {
  return (
    <section className="relative flex min-h-[45vh] w-full items-center overflow-hidden border-b border-line-subtle bg-elevated sm:min-h-[55vh]">
      <Image
        src={heroImage}
        alt=""
        fill
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center gap-4 px-4 py-16 text-center sm:px-6 sm:py-24">
        ...
        <p className="max-w-2xl text-base leading-relaxed text-ink-secondary sm:text-lg">
          Reach out for general inquiries, partnership opportunities, media
          questions, or any other matter related to the organization.
        </p>
      </div>
    </section>
  );
